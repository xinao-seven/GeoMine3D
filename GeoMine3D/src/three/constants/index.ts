export const SCENE_BACKGROUND_COLOR = 0x101512
export const GRID_COLOR = 0x34443a
...
export const HIGHLIGHT_COLOR = 0x6aa48c
export const SELECTION_COLOR = 0xd49a54
