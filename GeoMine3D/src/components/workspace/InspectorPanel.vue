<template>
    <aside class="inspector-panel">
        ...
        <div class="inspector-section">
            ...
            <label><span>边缘线</span><el-switch :model-value="showEdges" size="small"
...
.selection-summary {
    padding: 18px 16px;
    background: linear-gradient(135deg, rgba(177, 124, 62, .16), transparent);
    border-bottom: 1px solid var(--studio-border)
}
...
.empty-selection .crosshair {
    font: 300 35px Georgia;
    color: #8a6840
}
...
.property-wrap :deep(.panel-title),
.property-wrap :deep(.empty-hint) {
    display: none
}

.property-wrap :deep(.property-panel) {
    padding: 15px 16px
}
