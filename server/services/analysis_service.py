from services.borehole_excel_service import (
    get_thickness_stats,
    get_depth_stats,
    get_layer_frequency,
    get_borehole_list,
    get_borehole_raw_locations,
)
from services.workingface_service import get_status_stats, get_workingface_list
from services.model_service import get_model_list
...
def get_borehole_count():
    ...
    return {'total': len(boreholes), 'items': boreholes}
